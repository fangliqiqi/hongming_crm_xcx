	...
	<view class="dataCollection">
		...
		<view class="content_three">
			...
			<view class="uploadingImg">
				<!-- <view class="show" v-if="changeimgList!=[]" v-for="(item,index) in changeimgList">
					<image  class="headimgsize" :src="item" ></image>
				</view> -->
			 ...
			 <view v-if="richText==''">暂无数据</view>
				<!-- <view class="three_imageBox" v-for="(item,index) in someimgList" >
					<image class="imageBox_img" :src="item.url" mode="aspectFit"></image>
				</view>
				<view class="three_imageBox" v-if="changeimg!=''">
					<image class="imageBox_img" :src="changeimg" mode="aspectFit" ></image>
				</view> -->
			<!-- 	<view class="uploading"  @click="onUpload" v-if="byValue.enable==20">
					<image class="headimgsize" src="@/static/image/uploading.png" mode="aspectFit" ></image>
...
<!--  -->
		<!-- <view class="bottom" v-if="byValue.enable!=10">
