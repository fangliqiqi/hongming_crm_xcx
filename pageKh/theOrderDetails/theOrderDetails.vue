			...
			<view class="content_box">
				...
				<view class='box_child  dataGather ' v-if="dataList.length>=2">
					...
					<view class="childContent">
						...
						<view class="btnBox" v-if="dataList[1].enable==20" >
							<view class="data" @click="datum">资料</view>
							<view class="contract" @click="contract(dataList[1])">合同</view>
						</view>
	...
	export default {
		...
		methods: {
			...
			getList() {
				...
				this.$u.get('/client/findOrderDetails', {
					id: id
				}).then(resp => {
					this.dataList = resp
			...
			datum() {
				...
				uni.navigateTo({
					url: "/pageKh/theOrderDetails/dataCollection/dataCollection?byValue=" +
			...
			contract(e) {
				...
				console.log('跳转到合同详情')
					...
					uni.navigateTo({
							...
							url: "/pageKh/theOrderDetails/contractList/contractList?item=" +
