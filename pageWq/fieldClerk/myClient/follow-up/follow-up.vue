<template>
	<view class="followUp">
		...
		<view class="content_tow">
			...
			<input class="uni-input" focus placeholder="请输入本次跟进内容" placeholder-style='color:#D2D3D6;'
		...
		<view class="nextTime_content">
			...
			<input class="uni-input" focus placeholder="请输入下次跟进内容" placeholder-style='color:#D2D3D6;'
		...
		<u-calendar v-model="showPicker" mode="date" @change="onSelected" max-date="2033-01-01" :min-date="minDate" :safe-area-inset-bottom="true"></u-calendar>
	</view>
</template>
